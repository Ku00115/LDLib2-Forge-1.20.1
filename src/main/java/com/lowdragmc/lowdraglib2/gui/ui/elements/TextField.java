...
public class TextField extends BindableUIElement<String> {
    private record NumberStart(double numberStart){}
    private record CursorStart(int cursorStart){}
    ...
    protected void onDragSource(UIEvent event) {
        if (isNumberField()) {
            if (event.dragHandler.draggingObject instanceof NumberStart numberStartDrag) {
                double numberStart = numberStartDrag.numberStart();
        ...
        } else if (event.dragHandler.draggingObject instanceof CursorStart cursorStartDrag) {
            int cursorStart = cursorStartDrag.cursorStart();
