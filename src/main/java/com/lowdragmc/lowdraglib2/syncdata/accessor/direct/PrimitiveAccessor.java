...
public final class PrimitiveAccessor<TYPE> implements IDirectAccessor<TYPE> {
    ...
    private final StreamCodec<FriendlyByteBuf, TYPE> streamCodec;

    private PrimitiveAccessor(PrimitiveCodec<TYPE> codec, StreamCodec<FriendlyByteBuf, TYPE> streamCodec, Class<?> ...operandTypes) {
        this.operandTypes = operandTypes;
        this.codec = codec;
        this.streamCodec = streamCodec;
    }

    public static <T> PrimitiveAccessor<T> of(PrimitiveCodec<T> codec, StreamCodec<FriendlyByteBuf, T> streamCodec, Class<?> ...operandTypes) {
