...
public class CustomDirectAccessor<TYPE> implements IDirectAccessor<TYPE>, IMarkFunction<TYPE, Object> {
    ...
    protected CustomDirectAccessor(Class<TYPE> type, boolean supportChildClass,
                                   Codec<TYPE> codec, StreamCodec<? super FriendlyByteBuf, TYPE> streamCodec,
    ...
    public <T> T readDirectVar(DynamicOps<T> op, IVar<TYPE> var) {
        return codec.encodeStart(op, var.value()).getOrThrow(false, System.err::println);
    }

    @Override
    public <T> void writeDirectVar(DynamicOps<T> op, IVar<TYPE> var, T payload) {
        var.set(codec.parse(op, payload).getOrThrow(false, System.err::println));
    }
    ...
    public static class Builder<TYPE> {
        ...
        private StreamCodec<? super FriendlyByteBuf, TYPE> streamCodec;
        ...
        public Builder<TYPE> streamCodec(StreamCodec<? super FriendlyByteBuf, TYPE> streamCodec) {
            this.streamCodec = streamCodec;
            return this;
        }
        ...
        public Builder<TYPE> codecMark() {
            this.markFunction = new IMarkFunction.Simple<>(
                    value -> codec.encodeStart(Platform.createSerializationContext(NbtOps.INSTANCE), value).getOrThrow(false, System.err::println),
                    (mark, value) -> !Objects.equals(mark, codec.encodeStart(Platform.createSerializationContext(NbtOps.INSTANCE), value).getOrThrow(false, System.err::println)));
            return this;
        }
