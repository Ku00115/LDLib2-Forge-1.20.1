...
public interface MixinPluginShared {
	...
	boolean IS_REI_LOAD = isModLoaded("roughlyenoughitems") || isModLoaded("rei");
	boolean IS_EMI_LOADED = isModLoaded("emi");
	boolean IS_RUBIDIUM_LOAD = isModLoaded("rubidium") || isModLoaded("embeddium");
	boolean IS_IRIS_LOAD = isModLoaded("iris");
	boolean IS_OCULUS_LOAD = isModLoaded("oculus");
