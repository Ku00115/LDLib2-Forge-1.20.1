    ...
    public static ModelBaker getModelBaker() {
        return new ModelBaker() {
            ...
            public @Nullable BakedModel bakeUncached(UnbakedModel unbakedModel, ModelState modelState, Function<Material, TextureAtlasSprite> function) {
                if (unbakedModel instanceof BlockModel blockmodel) {
                    if (blockmodel.getRootModel() == ModelBakery.GENERATION_MARKER) {
                        return ITEM_MODEL_GENERATOR.generateBlockModel(Material::sprite, blockmodel).bake(this, blockmodel, Material::sprite, modelState, ModelBakery.MISSING_MODEL_LOCATION, false);
                    }
                }
                return unbakedModel.bake(this, Material::sprite, modelState, ModelBakery.MISSING_MODEL_LOCATION);
            }
    ...
    public static ModelBaker getRegisteredModelBaker() {
        return new ModelBaker() {
            ...
            public @Nullable BakedModel bakeUncached(UnbakedModel unbakedModel, ModelState modelState, Function<Material, TextureAtlasSprite> function) {
                if (unbakedModel instanceof BlockModel blockmodel) {
                    if (blockmodel.getRootModel() == ModelBakery.GENERATION_MARKER) {
                        return ITEM_MODEL_GENERATOR.generateBlockModel(function, blockmodel).bake(this, blockmodel, function, modelState, ModelBakery.MISSING_MODEL_LOCATION, false);
                    }
                }
                return unbakedModel.bake(this, function, modelState, ModelBakery.MISSING_MODEL_LOCATION);
            }
