...
public class LDLRendererModel implements IUnbakedGeometry<LDLRendererModel> {
    ...
    @Override
    public BakedModel bake(IGeometryBakingContext iGeometryBakingContext, ModelBaker arg, Function<Material, TextureAtlasSprite> function, ModelState arg2, ItemOverrides arg3, ResourceLocation location) {
