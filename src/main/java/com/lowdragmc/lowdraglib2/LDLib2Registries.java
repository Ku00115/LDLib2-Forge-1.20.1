...
public class LDLib2Registries {
    ...
    public static void init() {
        if (LDLib2.isClient()) {
            GUI_TEXTURES.registerOrOverride("empty", AutoRegistry.Holder.of(
                    IGuiTexture.EmptyTexture.class.getAnnotation(LDLRegisterClient.class),
                    IGuiTexture.EmptyTexture.class,
                    () -> IGuiTexture.EMPTY));
            GUI_TEXTURES.registerOrOverride("missing", AutoRegistry.Holder.of(
            ...
            RENDERERS.registerOrOverride("empty", AutoRegistry.Holder.of(
