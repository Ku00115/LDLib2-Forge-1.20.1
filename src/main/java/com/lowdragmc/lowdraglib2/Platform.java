...
public class Platform {
    ...
    public static <T> RegistryOps<T> createSerializationContext(DynamicOps<T> ops) {
        return createSerializationContext(getFrozenRegistry(), ops);
    }

    public static <T> RegistryOps<T> createSerializationContext(HolderLookup.Provider provider, DynamicOps<T> ops) {
