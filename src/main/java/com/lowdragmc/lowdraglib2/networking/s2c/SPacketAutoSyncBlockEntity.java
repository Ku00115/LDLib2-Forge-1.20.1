...
public class SPacketAutoSyncBlockEntity extends PacketIntLocation {
    public static final StreamCodec<FriendlyByteBuf, SPacketAutoSyncBlockEntity> CODEC = StreamCodec.ofMember(SPacketAutoSyncBlockEntity::write, SPacketAutoSyncBlockEntity::decode);
    ...
    public static void execute(SPacketAutoSyncBlockEntity packet, NetworkPayloadContext context) {
