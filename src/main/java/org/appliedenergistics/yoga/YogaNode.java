...
import org.appliedenergistics.yoga.algorithm.FlexDirectionUtil;
...
import static org.appliedenergistics.yoga.numeric.Comparison.isDefined;
import static org.appliedenergistics.yoga.numeric.Comparison.isUndefined;
import static org.appliedenergistics.yoga.numeric.Comparison.maxOrDefined;
...
public class YogaNode implements YogaProps {
    ...
    public void setDirty(boolean isDirty) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] mark dirty");
        }
    }
    ...
    public void setLayoutDirection(YogaDirection direction) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout direction = " + direction);
        }
    }
    ...
    public void setLayoutMargin(float margin, YogaPhysicalEdge edge) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout margin " + edge + " = " + f(margin));
        }
    }
    ...
    public void setLayoutBorder(float border, YogaPhysicalEdge edge) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout border " + edge + " = " + f(border));
        }
    }
    ...
    public void setLayoutPadding(float padding, YogaPhysicalEdge edge) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout padding " + edge + " = " + f(padding));
        }
    }
    ...
    public void setLayoutLastOwnerDirection(YogaDirection direction) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout last owner direction = " + direction);
        }
    }
    ...
    public void setLayoutComputedFlexBasis(FloatOptional computedFlexBasis) {
        ...
        if (debugName != null) {
            if (computedFlexBasis.isUndefined()) {
                System.out.println("[" + debugName + "] computed flex basis = undefined");
            } else {
                System.out.println("[" + debugName + "] computed flex basis = " + f(computedFlexBasis.unwrap()));
            }
        }
    }
    ...
    public void setLayoutPosition(float position, YogaPhysicalEdge edge) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout position " + edge + " = " + f(position));
        }
    }
    ...
    public void setLayoutComputedFlexBasisGeneration(long computedFlexBasisGeneration) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout computed flex basis generation = " + computedFlexBasisGeneration);
        }
    }
    ...
    public void setLayoutMeasuredDimension(float measuredDimension, YogaDimension dimension) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout measured " + dimension + " = " + f(measuredDimension));
        }
    }
    ...
    public void setLayoutHadOverflow(boolean hadOverflow) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout had overflow = " + hadOverflow);
        }
    }
    ...
    public void setLayoutDimension(float lengthValue, YogaDimension dimension) {
        ...
        if (debugName != null) {
            System.out.println("[" + debugName + "] layout " + dimension + " = " + f(lengthValue));
        }
    }
